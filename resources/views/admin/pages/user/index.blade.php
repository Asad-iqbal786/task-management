        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-5">
                            <a href="{{ route('addEditUser') }}" class="btn btn-info">Add User</a>
                        </div>
                        <div class="col-sm-7">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                                ...
                                                style="width: 320.594px;">Email</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                                rowspan="1" colspan="1"
                                                aria-label="type: activate to sort column ascending"
                                                style="width: 320.594px;">Role</th>
                                        ...
                                        @foreach ($users as $index => $user)
                                            <tr>
                                                ...
                                                <td class="table-action">
                                                    @if ($user['role'] != 'admin')
                                                        <a href="{{ route('addEditUser', $user['id']) }}"
                                                            class="btn btn-info action-icon">
                                                            <i class="mdi mdi-square-edit-outline"></i>
                                                        </a>
                                                        {{-- <a href="{{ route('', $user->id) }}"
                                                            class="btn btn-danger action-icon"> <i
                                                        ...
                                                        <form id="delete-form-{{ $user['id'] }}"
                                                            action="{{ route('userDestroy', $user['id']) }}" method="POST"
                                                            style="display: none;">
                                                            @csrf
                                                            @method('get')
                                                        </form>
